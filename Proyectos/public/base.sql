...
-- Schema Sexto2.0
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `Sexto2.0` DEFAULT CHARACTER SET utf8 ;
USE `Sexto2.0` ;

-- -----------------------------------------------------
-- Table `Sexto2.0`.`Proveedores`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `Sexto2.0`.`Proveedores` (
...
-- -----------------------------------------------------
-- Table `Sexto2.0`.`Productos`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `Sexto2.0`.`Productos` (
...
-- -----------------------------------------------------
-- Table `Sexto2.0`.`Unidad_Medida`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `Sexto2.0`.`Unidad_Medida` (
...
-- Table `Sexto2.0`.`IVA`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `Sexto2.0`.`IVA` (
...
-- -----------------------------------------------------
-- Table `Sexto2.0`.`Kardex`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `Sexto2.0`.`Kardex` (
  ...
  CONSTRAINT `fk_Kardex_Unidad_Medida`
    ...
    REFERENCES `Sexto2.0`.`Unidad_Medida` (`idUnidad_Medida`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  ...
  CONSTRAINT `fk_Kardex_IVA1`
    ...
    REFERENCES `Sexto2.0`.`IVA` (`idIVA`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_Kardex_Proveedores1`
    FOREIGN KEY (`Proveedores_idProveedores`)
    REFERENCES `Sexto2.0`.`Proveedores` (`idProveedores`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_Kardex_Productos1`
    FOREIGN KEY (`Productos_idProductos`)
    REFERENCES `Sexto2.0`.`Productos` (`idProductos`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `Sexto2.0`.`Clientes`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `Sexto2.0`.`Clientes` (
...
-- -----------------------------------------------------
-- Table `Sexto2.0`.`Factura`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `Sexto2.0`.`Factura` (
  ...
  CONSTRAINT `fk_Factura_Clientes1`
    ...
    REFERENCES `Sexto2.0`.`Clientes` (`idClientes`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `Sexto2.0`.`Detalle_Factura`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `Sexto2.0`.`Detalle_Factura` (
  ...
  CONSTRAINT `fk_Detalle_Factura_Factura1`
    ...
    REFERENCES `Sexto2.0`.`Factura` (`idFactura`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_Detalle_Factura_Kardex1`
    FOREIGN KEY (`Kardex_idKardex`)
    REFERENCES `Sexto2.0`.`Kardex` (`idKardex`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
